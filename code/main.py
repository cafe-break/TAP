...
if __name__ == '__main__':
    ...
    for idx in range(args.session):
        ...
        all_acc_test, all_f1_test, base_acc_test, base_f1_test, seen_acc_test, seen_f1_test, t_features, t_labels, novel_acc_test \
        ...
        print("Session: {:2d}, all_test_acc: {:.4f}, "
              "base_test_acc: {:.4f}, "
              "seen_test_acc: {:.4f}, novel_test_acc: {}".format(idx + 1, all_acc_test, base_acc_test, seen_acc_test,
                                                                 novel_acc_test))
